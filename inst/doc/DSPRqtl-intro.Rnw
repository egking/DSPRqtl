...
probabilities on the measured phenotype at evenly spaced 10kb
...
\begin{itemize}
  ...
  section 3 containing the RIL IDs, phenotype, and any covariates.
...
\begin{itemize}
  ...
  (on either side, positions are 10kb apart)
