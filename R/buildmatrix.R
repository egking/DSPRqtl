#designs inbredA/inbredB/ABcross/AAcross/BBcross
      ...
      if(design=='AAcross')
      {
        ...
        {  
          ...
          if(poslist[i,1]=='X')
          {
            ...
            mgeno<-matgeno[,c('AA1','AA2','AA3','AA4','AA5','AA6','AA7','AA8','id')]
        ...
        if(design=='BBcross')
        {
          ...
          if(poslist[i,1]=='X')
          {
            ...
            mmatgeno<-matgeno[matgeno$sex=='m',]
            mgeno<-matgeno[,c('BB1','BB2','BB3','BB4','BB5','BB6','BB7','BB8','id')]
            genos<-rbind(fgeno,mgeno)
            ...
            row.names(genos)<-patgeno$id
            big.list[[i]]<-genos
            rm(list=objname,pos=.GlobalEnv)BB          }
        }else{
      ...
      if(design=='ABcross')
      {
        for (i in 1:length(big.list)) 
        {
          ...
          Bgenotypes<-get(objnameB)
            ...
            if(poslist[i,1]=='X')
            {
            	genotypes[genotypes$sex=='m' & genotypes$matRIL<21000,c("BB1","BB2","BB3","BB4","BB5","BB6","BB7","BB8")]<-'NA'
            	genotypes[genotypes$sex=='m' & genotypes$matRIL>21000,c("AA1","AA2","AA3","AA4","AA5","AA6","AA7","AA8")]<-'NA'
            }
...
return(list('genolist'=big.list,'pheno'=phenotype.dat))
}#function close
